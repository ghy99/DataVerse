...
from ckanext.datatables_view import blueprint
...
class DatatablesViewPlugin(plugins.SingletonPlugin):
    u'''
    ...
    def update_config(self, config: CKANConfig):
        ...
        toolkit.add_resource(u'assets', u'datatables_view')
    ...
    def info(self) -> dict[str, Any]:
        return {
            ...
            u'default_title': plugins.toolkit._(u'Table'),
