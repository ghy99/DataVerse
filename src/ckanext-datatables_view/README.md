...
This extension is used to display table previews (CSV files) in datasets. 
When a user uploads e.g. a CSV file for the preview, this extension is used to display the table div so that the preview can be displayed. 
...
2. Add your extension name to your .env file. 
   ...
   `CKAN__PLUGINS="envvars datatables_view"`
