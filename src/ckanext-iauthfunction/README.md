...
To install ckanext-iauthfunction:
...
3. Add `iauthfunction` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.iauthfunction.some_setting = some_default_value
...
## Releasing a new version of ckanext-iauthfunction

If ckanext-iauthfunction should be available on PyPI you can follow these steps to publish a new version:
